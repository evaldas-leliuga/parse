...
use Parse\Eloquent\Relations\HasOne;
use Parse\Eloquent\Relations\HasMany;
use Parse\Eloquent\Relations\Relation;
use Parse\Eloquent\Relations\BelongsTo;
use Illuminate\Contracts\Support\Jsonable;
use Illuminate\Contracts\Support\Arrayable;
use Parse\Eloquent\Relations\HasManyArray;
use Parse\Eloquent\Relations\BelongsToMany;
	...
	protected function getRelationshipFromMethod($method)
	{
		...
		if (!$relations instanceof Relation) {
			throw new LogicException('Relationship method must return an object of type '
				. 'Parse\Eloquent\Relations\Relation');
		}
